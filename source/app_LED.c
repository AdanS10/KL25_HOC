...
void app_LED_Init(void)
{
	...
	PORT_SetPinMux(PORTB, APP_LED_GREEN_PIN_NUMBER, kPORT_MuxAsGpio);
	PORT_SetPinMux(PORTD, APP_LED_BLUE_PIN_NUMBER, kPORT_MuxAsGpio);
	...
	GPIO_PinInit(GPIOB, APP_LED_GREEN_PIN_NUMBER, &ls_PinConfig);
	GPIO_PinInit(GPIOD, APP_LED_BLUE_PIN_NUMBER, &ls_PinConfig);
}
